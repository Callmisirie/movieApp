...
import useFecth from '@/services/useFectch';
...
const MoviesDetails = () => {
  ...
  const {data: movie, loading} = useFecth(() => fetchMovieDetails(id as string))
  return (
    <View className='bg-primary flex-1'>
      ...
      <TouchableOpacity className='absolute bottom-5 left-5 
      right-0 mx-5 bg-accent rounded-lg py-3.5
      flex flex-row text-center justify-center z-50'
        onPress={router.back}>
